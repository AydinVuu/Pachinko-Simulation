...
screen_height = 700
gravity = 9.8
left_boundary = screen_width * 0.1
right_boundary = screen_width * 0.9
...
bigball2 = BigBall(screen,[350,380], big_ball_color, 40)
bigball3 = BigBall(screen,[150,580], big_ball_color, 50)
bigball4 = BigBall(screen,[900,200], big_ball_color, 30)
bigball5 = BigBall (screen, [850,530], big_ball_color, 50)
bigball6 = BigBall(screen, [575, 200], big_ball_color,40)
bigball7 = BigBall(screen,[170,150], big_ball_color, 25)
bigballs = [bigball,bigball2, bigball3, bigball4, bigball5, bigball6, bigball7]
tripoints = np.array([[500,380],[590,530],[410,530]])
tripoints2 = np.array([[1110,550],[1150,600],[1000,600]])
triangle = Triangle(screen, tripoints, triangle_color)
triangle2 = Triangle(screen,tripoints2,triangle_color)
...
while True:
    ...
    if (ball.position[1] - radius) > screen_height + 30:
        #Point sections
        segment = screen_width//5
        if (ball.position[0] >= 0 and ball.position[0] < segment):
            score += 100
        elif (ball.position[0] >= segment and ball.position[0] < segment*2):
            score += 200
        elif (ball.position[0] >= segment*2 and ball.position[0] < segment*3):
            score += 300
        elif (ball.position[0] >= segment*3 and ball.position[0] < segment*4):
            score += 200
        elif (ball.position[0] >= segment*4 and ball.position[0] <= segment*5):
            score += 100
        Scoretext = "Score: %i" % score
    ...
    #Score Grids
    pygame.draw.rect(screen, BLUE, (0, screen_height-20, screen_width/5, screen_height/10))
    pygame.draw.rect(screen, RED, ((screen_width/5), screen_height-20, screen_width/5, screen_height/10))
    pygame.draw.rect(screen, BLACK, ((screen_width/5)*2, screen_height-20, screen_width/5, screen_height/10))
    pygame.draw.rect(screen, RED, ((screen_width/5)*3, screen_height-20, screen_width/5, screen_height/10))
    pygame.draw.rect(screen, BLUE, ((screen_width/5)*4, screen_height-20, screen_width/5, screen_height/10))
